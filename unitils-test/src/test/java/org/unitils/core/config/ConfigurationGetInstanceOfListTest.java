 ...
 * @author Tim Ducheyne
 */
public class ConfigurationGetInstanceOfListTest {
    ...
    public void valid() {
        ...
        List<TestInterface> result = configuration.getInstanceOfList(TestInterface.class);
    ...
    public void notFoundWhenOnlyEmptyValues() {
        ...
        List<TestInterface> result = configuration.getInstanceOfList(TestInterface.class, "propertyWithOnlyEmptyValues");
        assertTrue(result.isEmpty());
    }
    ...
    public void notFoundWhenEmpty() {
        ...
        List<TestInterface> result = configuration.getInstanceOfList(TestInterface.class, "empty");
        assertTrue(result.isEmpty());
    }
    ...
    public void valueWithClassifiers() {
        ...
        List<TestInterface> result = configuration.getInstanceOfList(TestInterface.class, "a", "b");
