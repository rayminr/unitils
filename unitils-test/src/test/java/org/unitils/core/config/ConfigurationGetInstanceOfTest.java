 ...
 * @author Tim Ducheyne
 */
public class ConfigurationGetInstanceOfTest {
    ...
    public void valid() {
        ...
        TestInterface result = configuration.getInstanceOf(TestInterface.class);
    ...
    public void invalidValue() {
        ...
        configuration.getInstanceOf(TestInterface.class);
    }
    ...
    public void notFound() {
        configuration.getInstanceOf(List.class);
    }
    ...
    public void valueWithClassifiers() {
        ...
        TestInterface result = configuration.getInstanceOf(TestInterface.class, "a", "b");
        assertTrue(result instanceof TestClass);
    }
    ...
    public void factory() {
        ...
        Map result = configuration.getInstanceOf(Map.class);
